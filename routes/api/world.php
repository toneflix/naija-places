...
Route::middleware([\App\Http\Middleware\ApiAccessMiddleware::class])->prefix('countries')->name('countries.')->group(function () {
    // Countries
...
Route::middleware([\App\Http\Middleware\ApiAccessMiddleware::class])->prefix('regions')->name('regions.')->group(function () {
    // Regions
...
Route::middleware([\App\Http\Middleware\ApiAccessMiddleware::class])->prefix('subregions')->name('subregions.')->group(function () {
